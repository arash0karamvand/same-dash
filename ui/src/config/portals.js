...
export const PORTALS = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'products', label: 'محصولات', icon: 'package', permission: 'view_products', group: 'CRM' },
      { key: 'factory', label: 'کارخانه — ساخت', icon: 'wrench', permission: 'view_factory_orders', group: 'CRM' },
      { key: 'factory-built', label: 'کارخانه — ساخته‌شده', icon: 'check', permission: 'view_factory_orders', group: 'CRM' },
      { key: 'freight', label: 'کارخانه — باربری', icon: 'truck', permission: 'view_freight_orders', group: 'CRM' },
      { key: 'warehouse', label: 'انبار', icon: 'package', anyPermission: ['view_warehouse_orders', 'manage_warehouse_orders', 'approve_sale_accounting'], group: 'CRM' },
      { key: 'filter', label: 'فیلتر', icon: 'search', anyPermission: ['view_accounting', 'approve_sale_accounting', 'view_sales', 'view_customers', 'view_installments'], group: 'CRM' },
